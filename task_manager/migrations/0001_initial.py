    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='workers', to='task_manager.position')),
            ],
            options={
                'ordering': ('id',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to='task_manager.tasktype')),
            ],
            options={
                'ordering': ('created_at',),
            },
